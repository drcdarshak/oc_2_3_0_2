...
//Form
$_['store_gmap_api_code'] = 'Google Javascript API Code';

// Text
$_['text_success'] = 'Success: You have modified store locator settings!';
...
$_['error_store_locator_google_map_api'] = 'Google Javascript API Code must not to be blank';
